...
class Database{
    ...
    public function initDatabaseTables(){
        ...
        $this->connection->exec('CREATE TABLE IF NOT EXISTS messages (id int AUTO_INCREMENT, sendby int, context longtext, sendto int, sendat timestamp, PRIMARY KEY (id), FOREIGN KEY (sendto) REFERENCES users(id), FOREIGN KEY (sendby) REFERENCES users(id));');
